...
public class DynamicBeat extends JFrame {
	...
	public DynamicBeat() {
		// 타이틀 이미지, 스타트 이미지, 게임 이미지, 타이틀 뮤직, 게임 뮤직, 곡 이름
		trackList.add(new Track("Tell Me That I Can't (Clean)_title.png", "Tell Me That I Can't (Clean)_start.png", "Tell Me That I Can't (Clean) - NEFFEX_game.jpg", "Tell Me That I Can't (Clean) - NEFFEX.mp3", "Tell Me That I Can't (Clean) - NEFFEX.mp3", "Tell Me That I Can't"));
		trackList.add(new Track("Would it Kill You_ - Mini Vandals_title.png", "Would it Kill You_ - Mini Vandals_start.png", "Would it Kill You_ - Mini Vandals_game.jpg", "Would it Kill You_ - Mini Vandals.mp3", "Would it Kill You_ - Mini Vandals.mp3", "Would it Kill You"));
		trackList.add(new Track("Fingerprint - Mini Vandals_title.png", "Fingerprint - Mini Vandals_start.png", "Fingerprint - Mini Vandals_game.jpg", "Fingerprint - Mini Vandals.mp3", "Fingerprint - Mini Vandals.mp3", "Fingerprint"));
